            ...
            describe(
                ...
                function(){
                    ...
                    it(
                    	"Test config type",
                    	function(){
                    		var config = new redis.config.SSLConnectionConfig();
                    		expect( config.getType() ).toBe("SSL");
                    ...
                    it(
                    	"Test config name",
                    	function(){
                    		var config = new redis.config.SSLConnectionConfig('base').name("my-great-connection");
					...
					it(
                    	...
                    	function(){
                    		var config = new redis.config.SSLConnectionConfig('base').database(1);
                    ...
                    it(
                    	...
                    	function(){
                    		var config = new redis.config.SSLConnectionConfig('base').timeout(60);
                    ...
                    it(
                    	...
                    	function(){
                    		var config = new redis.config.SSLConnectionConfig('base').timeout(60, "m").password("blabla");
					...
					it(
							...
							function(){
								...
								var config = new redis.config.SSLConnectionConfig('base').host('blabla:1717');	
					...
					it(
							...
							function(){
								...
								var config = new redis.config.SSLConnectionConfig('base').port("1616");	
